...
public:
	BoundaryWindPassiveScalar(double rhoWind, double velWind, double pressureWind, Grid& grid, EquationsEulerPassiveScalar& equations) : BoundaryWind(rhoWind, velWind, pressureWind, grid, equations) {};
